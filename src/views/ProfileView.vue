        ...
        <form class="grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div class="mb-2">
              ...
              <input type="text" placeholder="Enter first name" class="w-full border border-gray-300 p-2 rounded-lg" />
            </div>
            <div class="mb-2">
              <label class="block text-gray-500 mb-2">Surname</label>
              <input type="text" placeholder="Enter surname" class="w-full border border-gray-300 p-2 rounded-lg" />
            </div>
            <div class="mb-2">
              <label class="block text-gray-500 mb-2">National Code</label>
              <input type="text" placeholder="Enter national code"
          ...
          <div>
            ...
            <div class="mb-2">
              ...
              <input type="email" placeholder="Enter email" class="w-full border border-gray-300 p-2 rounded-lg" />
            </div>
            <div class="mb-2">
              <label class="block text-gray-500 mb-2">Phone Number</label>
              <input type="tel" placeholder="Enter phone number" class="w-full border border-gray-300 p-2 rounded-lg" />
            </div>
            <div class="mb-2">
            ...
            <div class="mb-2">
              ...
              <input type="text" placeholder="Enter city" class="w-full border border-gray-300 p-2 rounded-lg" />
            </div>
          </div>
        </form>
        <!-- Save Button -->
        <div class="mt-4">
          <button type="button" class="px-6 py-2 bg-green-500 text-white rounded-lg font-medium">
            Save
          </button>
        </div>
      </main>
